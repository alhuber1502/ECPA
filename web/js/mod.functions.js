...
// export model as PNG
$(document.body).on('click', '#seventhstep', function () {
	var b64key = 'base64,';
...
$(document.body).on('click', '#eighthstep', function () {
...
function create_shortcut(header, path) {
	...
	jf.form.push({ type: "htmlsnippet", value: "<div class='modal-body' id='modal-create'>" });
	jf.form.push({ type: "htmlsnippet", value: "<p><b>Please fill in</b> " + ((path.length > 1) ? "these " + path.length + " statements" : "this statement") + ".</p>" }, {
		key: "reification_title", "onInsert": function (evt) {
	...
	if (header.includes("glyphicon")) {
		jf.form.push({
			key: "reification", notitle: true, inlinetitle: "Reification? &nbsp; &nbsp; ", "onChange": function (evt) {
				var flag2 = document.querySelectorAll('[class*="reification_title"]');
		...
		case "event":
			...
			*/
			...
			jf.form.push({ type: "htmlsnippet", value: "<div class='modal-body' id='modal-create'><fieldset class='form-group' id='wd-image'><legend>Image</legend><img name='event.P18' src='' alt='[event image]' /></fieldset>" }, { key: "wd" }, { items: ["name", "description", "P31"], legend: "Event", title: "Event – this information will create an event record", type: "fieldset" }, { items: ["P276"], legend: "Location", title: "Location – this information will create an event location record", type: "fieldset" }, { items: ["P585"], legend: "Date", title: "Date – this information will create a date of event record", type: "fieldset" }, {
				...
				}], legend: "Participants", title: "Participants – this information will create one or more actor records", type: "fieldset"
			}, { "type": "fieldset", "title": "Additional information &#x2014 optional", "expandable": true, "items": ["label", "comment", "seeAlso", "isDefinedBy"] });
			// submit/cancel buttons
			jf.form.push({ type: "htmlsnippet", value: "</div><div class='modal-footer'>" });
...
$(document.body).on('click', '#rels_add', function (e) {
	...
	var path = [];
	path.push({
		s: { name: "s1", id: curr_stmt["s"], stype: "string" },
